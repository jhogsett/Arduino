...
public:
  ...
  void update_generator(){
    switch(_state){
      case STATE_NORMAL:
      case STATE_SOLO:
        _generator->setFrequency(0, _frequency / 10.0);
        _generator->setPhase(0, _phase);
        break;
      case STATE_MUTED:
        _generator->setFrequency(0, SILENT_FREQ);
        break;
    }
  }
  ...
  static const int MAX_FREQUENCY = 125000000L;
