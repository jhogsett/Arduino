...
void loop() {
  ...
  // float ival1 = val1 * PWM_MAX;
  // int i1 = int(ival1);

  // if(i1 >= 0 && i1 <= PWM_MAX - (BASE * BOOST))
  ...
  // float ival2 = val2 * PWM_MAX;
  // int i2 = int(ival2);

  // if(i2 >= 0 && i2 <= PWM_MAX - (BASE * BOOST))
  ...
  // float ival3 = val3 * PWM_MAX;
  // int i3 = int(ival3);

  // if(i3 >= 0 && i3 <= PWM_MAX - (BASE * BOOST))
