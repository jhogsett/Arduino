...
public:
  ...
  void begin(int blink_count, int blink_time=0, int blank_time=0, int gap_time=0){
    _blink_count = blink_count; // == 0 ? _blink_count : blink_count;  
    _blink_time = blink_time == 0 ? _blink_time : blink_time;
    _blank_time = blank_time == 0 ? _blank_time : blank_time;
    _gap_time = gap_time == 0 ? _gap_time : gap_time;
