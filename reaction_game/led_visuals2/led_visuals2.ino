...
void setup_display(){
  ...
  panel_leds.begin(time, LEDHandler::STYLE_PLAIN | LEDHandler::STYLE_RANDOM, 750, 350);
  button_leds.begin(time, LEDHandler::STYLE_RANDOM | LEDHandler::STYLE_RANDOM, 800, 400);
}
