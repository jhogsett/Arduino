...
const char template1[] PROGMEM = "Press A Button For FUN"; 
const char template2[] PROGMEM = "Play Silly Slots"; 
const char template3[] PROGMEM = "Play The TimeGame"; 
const char template4[] PROGMEM = "Long Press for OPTIONS"; 
...
const char nice4[] PROGMEM = "TACO";
const char nice5[] PROGMEM = "GOLD";
const char nice6[] PROGMEM = "MINT";
const char nice7[] PROGMEM = "GIFT";
const char nice8[] PROGMEM = "JADE";
const char nice9[] PROGMEM = "CAKE";
...
char *numeric_bet_str(long bet){
  sprintf(int_buffer, load_f_string(F("$%ld")), bet);
  return int_buffer;
}
...
void time_game(){
  ...
  int response;                                 
  // while((response = button_led_prompt(load_f_string(F("Press to Go")))) == -1);
  ...
  if(mean < best_time){
    ...
    micros_to_ms(int_buffer, best_time);
