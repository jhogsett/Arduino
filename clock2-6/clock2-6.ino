...
#define STEP 45
    ...
    polor_to_rect(RADIUS, 180.0 - angle, &x, &y);
    line(random_colors[random_color()], CENTERX, CENTERY, x, y); 
    //draw(random_colors[random_color()], x, y);

/*
    polor_to_rect(RADIUS / 2, 360.0 - angle, &x, &y);
    //line(random_colors[random_color()], CENTERX, CENTERY, x, y); 
    draw(random_colors[random_color()], x, y);
*/
...
/*    
    ...
    line(random_colors[random_color()], x1, y1, x2, y2); 
*/

  //draw(random_colors[random_color()], x1, y1);
  //draw(random_colors[random_color()], x2, y2);

    
/*
    line(green, 4,5,6,7); // works
    line(red, 5,6,7,8); // works
    line(purple, 6,5,7,8); // works
    line(ltblue, 6,5,8,7); // works
    line(ltgreen, 4,5,7,6); // works
