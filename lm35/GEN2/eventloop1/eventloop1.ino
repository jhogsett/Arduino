...
#define OVERHEAT_TEMP 90
#define OVERHEAT_MAX 110
#define REPORTING_FREQ 10

int reporting_counter = 0;

void loop() {
  // notes
  // sample often but check the samples less often
  ...
  digitalWrite(SETTLED_PIN, trend_detector->settled() ? HIGH : LOW);
  digitalWrite(COOLING_PIN, current_mode == MODE_COOLING ? HIGH : LOW);
