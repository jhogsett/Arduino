...
{
public:
  PriceHandler(char *buffer, int price_down_time, int price_down_amount, int price_min);
...
PriceHandler::PriceHandler(char *buffer, int price_down_time, int price_down_amount, int price_min){
  _buffer = buffer;
